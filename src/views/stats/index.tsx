...
let data : Data[] = stats?.gameResults.map(g => ({index: g.clueInformationLevel, blue: g.averageSpeed} as Data))!;
    data = [{index: 25, redLine: stats?.linearA! + stats?.linearB!*25},{index: 75, redLine: stats?.linearA! + stats?.linearB!*75}, ...data]
  ...
  return (
      <SideView>
          ...
          <motion.p>
              {`Linear: (${stats?.linearA}, ${stats?.linearB})`}
          </motion.p>
          <motion.p>
              <ComposedChart
                  width={900}
